    ...
    <div className="flex flex-col gap-[6px] items-start w-full flex-nowrap relative">
      {label && (
        <label className={`flex items-center gap-1 font-['Montserrat'] text-[12px] leading-[16px] ${labelColor}`}>
          ...
          {required && <span className="text-red-600 text-[14px] leading-[16px] align-middle">*</span>}
        </label>
      )}
      ...
      {error && (
        <span className="text-[11px] font-semibold text-red-600 font-['Montserrat'] absolute top-full left-0 mt-[2px] z-20">
          {error}
        </span>
      )}
    </div>
